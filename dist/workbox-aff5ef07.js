define(["exports"], (function (t) {
    ...
    function I(t) {
        return t !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (R || (R = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t) ? function (...e) {
            return t.apply(E(this), e), C(v.get(this))
        } : function (...e) {
            return C(t.apply(E(this), e))
        } : function (e, ...s) {
            const n = t.call(E(this), e, ...s);
            return q.set(n, e.sort ? e.sort() : [e]), C(n)
        }
    }

    function L(t) {
        return "function" == typeof t ? I(t) : (t instanceof IDBTransaction && function (t) {
            if (b.has(t)) return;
    ...
    class P {
        ...
        async getDb() {
            return this.h || (this.h = await function (t, e, {
                ...
                const a = indexedDB.open(t, e), o = C(a);
    ...
    class j {
        constructor(t, e = {}) {
            this.R = !1, this.v = !1, this.q = e.maxEntries, this.D = e.maxAgeSeconds, this.U = e.matchOptions, this.u = t, this._ = new P(t)
        }

        async expireEntries() {
            if (this.R) return void (this.v = !0);
            this.R = !0;
            const t = this.D ? Date.now() - 1e3 * this.D : 0, e = await this._.expireEntries(t, this.q),
        ...
        async isURLExpired(t) {
            if (this.D) {
                const e = await this._.getTimestamp(t), s = Date.now() - 1e3 * this.D;
                return void 0 === e || e < s
            }
            return !1
        }
    ...
    class W {
        ...
        isResponseCacheable(t) {
            let e = !0;
            return this.I && (e = this.I.includes(t.status)), this.L && e && (e = Object.keys(this.L).some((e => t.headers.get(e) === this.L[e]))), e
        }
    }
    ...
    const S = {cacheWillUpdate: async ({response: t}) => 200 === t.status || 0 === t.status ? t : null};
    ...
    class H {
        constructor(t, e) {
            this.C = {}, Object.assign(this, e), this.event = e.event, this.N = t, this.O = new A, this.k = [], this.B = [...t.plugins], this.T = new Map;
        ...
        async cacheMatch(t) {
            const e = F(t);
            let s;
            const {cacheName: n, matchOptions: i} = this.N, r = await this.getCacheKey(e, "read"),
        ...
        async cachePut(t, e) {
            ...
            if (!o) return !1;
            const {cacheName: c, matchOptions: h} = this.N, u = await self.caches.open(c),
        ...
        * iterateCallbacks(t) {
            for (const e of this.N.plugins) if ("function" == typeof e[t]) {
                const s = this.T.get(e), n = n => {
    ...
    handleAll(t)
    {
        ...
        const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
            n = "params" in t ? t.params : void 0, i = new H(this, {event: e, request: s, params: n}),
            r = this.P(i, s, e);
...
class Z extends ${constructor(t={}
)
{
    t.cacheName = f(t.cacheName), super(t), this.K = !1 !== t.fallbackToNetwork, this.plugins.push(Z.copyRedirectedCacheableResponsesPlugin)
}
async
W(t, e)
{
...
F(t, e)
{
    ...
    if (!this.K) throw new s("missing-precache-entry", {cacheName: this.cacheName, url: t.url});
    {
        ...
        n = await e.fetch(new Request(t, {integrity: "no-cors" !== t.mode ? r || s : void 0})), s && a && "no-cors" !== t.mode && (this.H(), await e.cachePut(t, n.clone()))
    }
    return n
}
async
...
class tt {
    constructor({cacheName: t, plugins: e = [], fallbackToNetwork: s = !0} = {}) {
        this.$ = new Map, this.G = new Map, this.V = new Map, this.N = new Z({
            cacheName: f(t),
    ...
    addToCacheList(t) {
        ...
        for (const n of t) {
            ...
            const {cacheKey: t, url: i} = V(n), r = "string" != typeof n && n.revision ? "reload" : "default";
            if (this.$.has(i) && this.$.get(i) !== t) throw new s("add-to-cache-list-conflicting-entries", {
                firstEntry: this.$.get(i),
                secondEntry: t
            });
            if ("string" != typeof n && n.integrity) {
                if (this.V.has(t) && this.V.get(t) !== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {url: i});
    ...
    install(t) {
        return G(t, (async () => {
            ...
            for (const [e, s] of this.$) {
                const n = this.V.get(s), i = this.G.get(e),
    ...
    activate(t) {
        return G(t, (async () => {
            const t = await self.caches.open(this.strategy.cacheName), e = await t.keys(), s = new Set(this.$.values()),
                n = [];
...
t.CacheableResponsePlugin = class {
    constructor(t) {
        this.cacheWillUpdate = async ({response: t}) => this.X.isResponseCacheable(t) ? t : null, this.X = new W(t)
    }
...
}, t.NetworkFirst = class extends ${constructor(t={}
)
{
    super(t), this.plugins.some((t => "cacheWillUpdate" in t)) || this.plugins.unshift(S), this.ot = t.networkTimeoutSeconds || 0
}
async
W(t, e)
{
...
async
ht({timeoutId: t, request: e, logs: s, handler: n})
{
    let i, r;
    try {
