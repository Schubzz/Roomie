define(["exports"], (function (t) {
    ...
    class C {
        ...
        handleAll(t) {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
                n = "params" in t ? t.params : void 0, i = new b(this, {event: e, request: s, params: n}),
                r = this.U(i, s, e);
    ...
    E.defaultPrecacheCacheabilityPlugin = {cacheWillUpdate: async ({response: t}) => !t || t.status >= 400 ? null : t}, E.copyRedirectedCacheableResponsesPlugin = {cacheWillUpdate: async ({response: t}) => t.redirected ? await m(t) : t};
    ...
    class O {
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                const {cacheKey: t, url: i} = p(n), r = "string" != typeof n && n.revision ? "reload" : "default";
        ...
        install(t) {
            return d(t, (async () => {
                ...
                for (const [e, s] of this.K) {
                    const n = this.T.get(s), i = this.P.get(e),
